...
def calculate_ik_for_frames(robot, frames):
    ...
    for frame in frames:
        ...
        configurations.append(robot.inverse_kinematics(frame, start_configuration))
...
def store_configurations(configurations, filename):
    #compas.json_dumps(configurations)
    compas.json_dump(configurations,'assignment-03.json')
